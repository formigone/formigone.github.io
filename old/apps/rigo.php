    ...
    <body>
        ...
        <script type="text/javascript">
            window.fbAsyncInit = function() {
                FB.init({appId: '174223252613144', status: true, cookie: true, xfbml: true});
            ...
            function login(){
                ...
                FB.api({ method: 'friends.get' }, function(result) {
                  var markup = '';
                  var numFriends = result ? Math.min(5000, result.length) : 0;
            ...
            function showStream(){
                FB.api('/me', function(response) {
                    ...
                    'Thinkdiff.net contains geeky stuff', 
                    'hrefTitle',
                    'http://thinkdiff.net', 
                    "Share thinkdiff.net");
                });
        ...
        <h3>Wanna see all your friends at once ?</h3>
        <p>
